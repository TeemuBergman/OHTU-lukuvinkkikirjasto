...
class TestTips(unittest.TestCase):
    ...
    def test_too_long_url(self):
        tip = self.tips.add_tip(
            "Arto Paasilinna",
            "https://www.wsoy.fi/kirja/arto-paasilinna/hurmaava-joukkoitsemurha/9789510426111/jaturhaa-koodia-peraan-etta-tulee-hylky/kun-merkkeja-tahan-tulee-201-etta-on-juurikin/raja-arvon-ylittava-maara-merkkeja")
        self.assertEqual(tip, False)
